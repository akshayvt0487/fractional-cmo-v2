...
export const metadata = createMetadata({
  ...
  openGraph: {
    ...
    type: "article",
    images: [{
      url: "https://fractional-cmo.com.au/images/blog/saas-marketing-it-sector-hero.jpg",
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    title: "Saas Marketing It Sector",
    description: "Expert guidance on saas marketing it sector. Learn proven strategies and best practices for business growth.",
    images: ["https://fractional-cmo.com.au/images/blog/saas-marketing-it-sector-hero.jpg"],
    site: "@FractionalCMO"
  }
});
