...
export const metadata = createMetadata({
  ...
  openGraph: {
    title: "Trade Business Growth Strategies",
    description: "Expert guidance on trade business growth strategies. Learn proven strategies and best practices for business growth.",
    url: "https://fractional-cmo.com.au/blog/trade-business-growth-strategies",
    siteName: "Fractional CMO",
    type: "article",
    images: [{
      url: "https://fractional-cmo.com.au/images/blog/trade-business-expansion-hero.jpg",
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    title: "Trade Business Growth Strategies",
    description: "Expert guidance on trade business growth strategies. Learn proven strategies and best practices for business growth.",
    images: ["https://fractional-cmo.com.au/images/blog/trade-business-expansion-hero.jpg"],
    site: "@FractionalCMO"
  }
});
  ...
  return <OptimizedBlogLayout articleData={articleData} relatedArticles={relatedArticles.tradies} faqs={faqs} heroImage={localSEOImage} heroAlt="Trade business owner reviewing growth strategies and expansion plans">
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6 mb-8 border-l-4 border-blue-500 not-prose">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-blue-900 mb-2">💡 Why This Matters for Your Business</h3>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8 not-prose">
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-blue-700 font-medium">Trade Industry Size</div>
              <div className="text-xs text-blue-600 mt-1">Total market opportunity</div>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-green-200 hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-green-700 font-medium">Annual Growth Rate</div>
              <div className="text-xs text-green-600 mt-1">Consistent year-over-year</div>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-br from-orange-50 to-amber-100 border-orange-200 hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-orange-700 font-medium">Small Business Market</div>
              <div className="text-xs text-orange-600 mt-1">Massive opportunity</div>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-br from-purple-50 to-indigo-100 border-purple-200 hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-purple-700 font-medium">Revenue per Worker</div>
              <div className="text-xs text-purple-600 mt-1">Industry average</div>
            </CardContent>
          </Card>
        </div>

        <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 border-l-4 border-amber-500 not-prose">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-amber-900 mb-2">🚀 The Growth Reality</h3>
