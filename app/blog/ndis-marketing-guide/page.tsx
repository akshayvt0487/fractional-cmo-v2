...
export const metadata = createMetadata({
  ...
  title: "NDIS Marketing Guide | Complete Strategy for Disability Service Providers 2026",
  ...
  path: "/blog/ndis-marketing-guide",
  keywords: ["ndis marketing", "disability service marketing", "ndis provider marketing", "participant acquisition", "disability business growth"],
  openGraph: {
    title: "NDIS Marketing Guide | Complete Strategy for Disability Service Providers 2026",
    description: "Comprehensive NDIS marketing guide for disability service providers. Learn proven strategies to attract participants, build trust, and grow your business.",
    url: "https://fractional-cmo.com.au/blog/ndis-marketing-guide",
    siteName: "Fractional CMO",
    type: "article",
    images: [{
      url: "https://fractional-cmo.com.au/images/blog/ndis-marketing-guide-new.jpg",
      width: 1200,
      height: 630,
      alt: "NDIS Marketing Guide for Disability Service Providers"
    }],
  ...
  twitter: {
    ...
    title: "NDIS Marketing Guide | Complete Strategy for Disability Service Providers 2026",
    description: "Comprehensive NDIS marketing guide for disability service providers. Learn proven strategies to attract participants and grow your business.",
    images: ["https://fractional-cmo.com.au/images/blog/ndis-marketing-guide-new.jpg"],
    site: "@FractionalCMO"
  }
});
const NDISMarketingGuide = () => {
  const post = blogPosts.find(p => p.slug === "ndis-marketing-guide");

  if (!post) throw new Error("Blog post not found: ndis-marketing-guide");
