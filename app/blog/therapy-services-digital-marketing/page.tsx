...
export const metadata = createMetadata({
  ...
  openGraph: {
    ...
    type: "article",
    images: [{
      url: "https://fractional-cmo.com.au/images/blog/therapy-services-digital-marketing-hero.jpg",
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    title: "Therapy Services Digital Marketing",
    description: "Expert guidance on therapy services digital marketing. Learn proven strategies and best practices for business growth.",
    images: ["https://fractional-cmo.com.au/images/blog/therapy-services-digital-marketing-hero.jpg"],
    site: "@FractionalCMO"
  }
});
  ...
  return <OptimizedBlogLayout articleData={articleData} relatedArticles={relatedArticles.ndis} faqs={faqs} heroImage={therapyServicesDigitalMarketingHero} heroAlt="Digital marketing strategies for therapy services including speech therapy, occupational therapy, and psychology practices">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-cyan-100 border-blue-200">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-blue-700 text-sm">Early intervention programs for communication development</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-4 w-4 text-blue-600 mt-1 shrink-0" />
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-green-200">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-green-700 text-sm">Daily living skills development and independence training</span>
              </div>
              <div className="flex items-start gap-3">
                <TrendingUp className="h-4 w-4 text-green-600 mt-1 shrink-0" />
                <span className="text-green-700 text-sm">Sensory integration therapy and motor skills enhancement</span>
              </div>
              <div className="bg-green-100 p-3 rounded-lg">
                <p className="text-xs text-green-800 font-medium">🚀 Success Rate: 92% of clients achieve their independence goals through structured OT programs.</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 my-8">
          <Card className="bg-gradient-to-br from-purple-50 to-violet-100 border-purple-200">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-start gap-3">
                <Target className="h-4 w-4 text-purple-600 mt-1 shrink-0" />
                <span className="text-purple-700 text-sm">Age-appropriate development guides and checklists</span>
              </div>
              <div className="flex items-start gap-3">
                <Target className="h-4 w-4 text-purple-600 mt-1 shrink-0" />
                <span className="text-purple-700 text-sm">Red flag indicators for early intervention</span>
              </div>
              <div className="bg-purple-100 p-3 rounded-lg">
                <p className="text-xs text-purple-800 font-medium">📚 Research shows: Early identification content increases parent awareness by 340%.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-orange-100 border-amber-200">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-start gap-3">
                <CheckCircle className="h-4 w-4 text-amber-600 mt-1 shrink-0" />
                <span className="text-amber-700 text-sm">Evidence-based therapy approach explanations</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-4 w-4 text-amber-600 mt-1 shrink-0" />
                <span className="text-amber-700 text-sm">Home practice activities and strategies</span>
              </div>
              <div className="bg-amber-100 p-3 rounded-lg">
                <p className="text-xs text-amber-800 font-medium">🎯 Impact: Families with home practice support show 65% faster progress rates.</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border-l-4 border-green-500">
            <h4 className="font-semibold mb-3 text-green-700">Email Newsletter Integration</h4>
            <p className="text-sm text-green-600">Weekly newsletters featuring therapy tips, success stories, and educational content help maintain relationships with families throughout their therapy journey.</p>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg mb-8">
          <h4 className="font-semibold mb-3 text-yellow-800">⚠️ Important Compliance Considerations:</h4>
