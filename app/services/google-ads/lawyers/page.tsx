...
const data = getIndustryServicePageData('lawyers', 'google-ads')!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://fractional-cmo.com.au/services/google-ads/lawyers`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: 'https://fractional-cmo.com.au/services/google-ads/lawyers',
    siteName: 'Fractional CMO',
    type: 'website',
    images: [{
      url: 'https://fractional-cmo.com.au/images/services/lawyers-google-ads-hero.jpg',
      width: 1200,
      height: 630,
      alt: data.metaTitle,
    }],
...
export default function LawyersGoogleAdsPage() {
