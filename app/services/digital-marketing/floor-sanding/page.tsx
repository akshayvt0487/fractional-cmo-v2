...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://fractional-cmo.com.au/services/digital-marketing/floor-sanding`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{
      url: 'https://fractional-cmo.com.au/images/services/floor-sanding-digital-marketing-hero.jpg',
      width: 1200,
      height: 630,
      alt: data.metaTitle,
    }],
