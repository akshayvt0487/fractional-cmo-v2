...
const data = getIndustryServicePageData('builders', 'digital-marketing')!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://fractional-cmo.com.au/services/digital-marketing/builders`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: 'https://fractional-cmo.com.au/services/digital-marketing/builders',
    siteName: 'Fractional CMO',
    type: 'website',
    images: [{
      url: 'https://fractional-cmo.com.au/images/services/builders-digital-marketing-hero.jpg',
      width: 1200,
      height: 630,
      alt: data.metaTitle,
    }],
