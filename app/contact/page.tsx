...
// ❌ REMOVE: useNavigate, useSearchParams from "react-router-dom"
...
// ✅ NEW: Import the client factory function
...
// ❌ REMOVE: import SEO from ... (Metadata is now handled via the export)


// --- 1. NEXT.JS METADATA EXPORT (Static SEO configuration) ---
// Note: This must be exported from a Page/Layout file. 
// If this file remains a component imported by a Page/Layout, move this export there.

// -------------------------------------------------------------------


const Contact = () => {
    // ⚠️ Instantiate Supabase Client (safe in a 'use client' component)
    const supabase = createClientBrowser();
    
    // ✅ Next.js router for navigation
    const router = useRouter(); 
    // ✅ Next.js hook for query parameters
...
    useEffect(() => {
        // ✅ Get param using Next.js useSearchParams interface
        const serviceParam = searchParams.get('service');
        if (serviceParam && serviceMapping[serviceParam]) {
          setFormData(prev => ({ ...prev, service: serviceMapping[serviceParam] }));
        }
    }, [searchParams]); // Depend on searchParams object provided by Next.js hook
...
    return (
      <>
        {/* ❌ REMOVED: <SEO ... /> - Handled by export const metadata above */}
        <Header />
