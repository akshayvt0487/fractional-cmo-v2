...
const Blog = () => {
  ...
  return (
    <>
      <SEO
        title="Marketing Blog for Service Businesses - Building & Construction, Trade, NDIS, Therapy, IT, Legal & SaaS Growth Strategies"
        description="Strategic marketing insights for service based businesses in Building & Construction, Trade, NDIS, Therapy, IT, Accounting, Finance and Legal. Practical guides for lead generation and growth."
        canonical="/blog"
      />
      <Header />
